...
public class KataRecognition extends AppCompatActivity {
    public static CharactersTest c = new CharactersTest();
    public static CharactersTest[] a = DataRec.getKata();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start_button.setOnClickListener(view -> startActivity(
                new Intent(KataRecognition.this, kata_rec_test.class)));
