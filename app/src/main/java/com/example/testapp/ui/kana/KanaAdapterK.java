...
public class KanaAdapterK extends RecyclerView.Adapter<KanaAdapterK.ViewHolder> {

    private final Context context;
    ArrayList<SavedItem> kanaList;
    private SavedDB kanaDB;

    public KanaAdapterK(Context context, ArrayList<SavedItem> kanaList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.topChar.setText(kanaList.get(position).getItem_kata()+"");
        holder.transChar.setText(kanaList.get(position).getItem_hira()+"");
